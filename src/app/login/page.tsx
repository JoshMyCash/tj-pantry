...
export default async function LoginPage({
  ...
  return (
    <div className="flex min-h-[75vh] items-center justify-center py-4">
      <section className="relative w-full max-w-md overflow-hidden rounded-2xl px-6 py-10 shadow-[0_24px_60px_rgba(28,36,48,0.18)] sm:px-8">
        <div
        ...
        <div className="relative z-10 text-white">
          <p className="brand-mark font-[family-name:var(--font-display)] text-5xl tracking-tight animate-rise">
            TJ Pantry
          </p>
          <h1 className="mt-4 text-lg font-medium text-white/90 animate-rise-delay">
